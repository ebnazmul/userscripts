[
  ...
  { name: "ask_details_bn", value: "সমস্যাটি সম্পর্কে আরও বিস্তারিত জানাবেন।", color: "#f59e0b" },
  ...
  { name: "hold_bn", value: "কিছুটা সময় দিন, আমি বিষয়টি চেক করছি।", color: "#16a34a" },

  { name: "wait_en", value: "Thanks for your patience. I'm looking into this right now.", color: "#22c55e" },
  { name: "wait_bn", value: "আমি বিষয়টি এখনও দেখছি। আরও কিছুক্ষন সময় দিয়ে সহযোগিতা করুন।", color: "#22c55e" },
  ...
  { name: "fixed_bn", value: "সমস্যাটি সমাধান করা হয়েছে। চেক করে জানান।", color: "#10b981" },
  ...
  { name: "closing_bn", value: "আর কোনো বিষয়ে কি আমি আপনাকে সাহায্য করতে পারি?", color: "#84cc16" },
